...
function ContinueClick() {
  ...
  if (userId.match(regExp1)) {
    document.getElementById("userMsg1").innerHTML = "Email-id added";
    ...
    if (userId.match(regExp2)) {
      document.getElementById("userMsg1").innerHTML = "Number added";
      document.getElementById("userMsg2").innerHTML = "";
      document.getElementById("UserId").value=""
    } else {
      document.getElementById("userMsg2").innerHTML ="Invalid Email or Mobile";
